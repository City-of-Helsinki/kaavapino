...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        projects = Project.objects.all() if process_all else Project.objects.filter(pk=project_id)
            ...
            with transaction.atomic():
                for project in projects:
                    ...
                    if not to_be_removed:
                        print("No incorrect deadlines for project " + str(project.id))
                        continue
                    else:
                        print (str(len(to_be_removed)) + " wrong deadlines found for project " + str(project.id))
