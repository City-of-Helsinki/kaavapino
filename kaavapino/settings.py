...
KAAVOITUS_API_BASE_URL = env("KAAVOITUS_API_BASE_URL")
KAAVOITUS_API_AUTH_TOKEN = env("KAAVOITUS_API_AUTH_TOKEN")

GRAPH_API_LOGIN_BASE_URL = env("GRAPH_API_LOGIN_BASE_URL")
GRAPH_API_BASE_URL = env("GRAPH_API_BASE_URL")
GRAPH_API_APPLICATION_ID = env("GRAPH_API_APPLICATION_ID")
GRAPH_API_TENANT_ID = env("GRAPH_API_TENANT_ID")
GRAPH_API_CLIENT_SECRET = env("GRAPH_API_CLIENT_SECRET")
...
RAVEN_CONFIG = {"dsn": env("SENTRY_DSN"), "release": version}
...
NGINX_X_ACCEL = env("NGINX_X_ACCEL")
